...
--update propietario set paterno = 'Molina' where materno = 'Paladino';
--update propietario set paterno = 'Molina' where materno = 'Tankus';
--update propietario set paterno = 'Molina' where materno = 'McCory';
...
--update vehiculo set marca = 'VW' where marca = 'BMW';
...
--INSERT INTO Multa(numMulta,RFC,numPlaca,NumAgente,Fecha,Calle,Entre1,Entre2,CP,Municipio,Referencia) VALUES (6565698,'BOFL861227YRF','ALV349',151,'2021-10-08','Mariners','Mayer','Nobel',81799,'Nochistlan de Mejia','Future-proofed optimal methodology');
--INSERT INTO Multa(numMulta,RFC,numPlaca,NumAgente,Fecha,Calle,Entre1,Entre2,CP,Municipio,Referencia) VALUES (1545955,'RIVP770306GOI','ALV690',154,'2020-07-28','Jazmin Cove','Quincy','Barby',21499,'Temoac','Multi-lateral bi-directional monitoring');
--INSERT INTO Multa(numMulta,RFC,numPlaca,NumAgente,Fecha,Calle,Entre1,Entre2,CP,Municipio,Referencia) VALUES (4142568,'FUMJ950122MUB','ALV301',159,'2019-04-26','Mendonta','Melvin','Claremont',91805,'El Fuerte','Team-oriented systematic customer loyalty');
--INSERT INTO Multa(numMulta,RFC,numPlaca,NumAgente,Fecha,Calle,Entre1,Entre2,CP,Municipio,Referencia) VALUES (0827262,'PHHA950116VCM','ALV381',160,'2020-12-11','Homewood','Rieder','1st',81374,'Tamuin','Monitored didactic architecture');
...
select fechacompra from poseer where fechacompra > cast('2020-10-10' as date)
